...
import { Building2, Plus, Edit2, X, Upload, ImageOff, Check, XCircle } from 'lucide-react';
...
const SuperAdmin = () => {
  const { restaurantes, addRestaurante, updateRestaurante, fetchRestaurantes } = useStore();
